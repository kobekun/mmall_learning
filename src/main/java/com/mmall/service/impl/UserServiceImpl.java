...
public class UserServiceImpl implements IUserService {
    ...
    public ServerResponse<String> forgetResetPassword(String username,String passwordNew,String forgetToken){
        ...
        String forgetTokenCache = TokenCache.getValue(TokenCache.TOKEN_PREFIX+username);
        if(org.apache.commons.lang3.StringUtils.isBlank(forgetTokenCache)){
            return ServerResponse.createByErrorMessage("token无效或者过期！");
        }
        if(org.apache.commons.lang3.StringUtils.equals(forgetToken,forgetTokenCache)){
    ...
    public ServerResponse<User> updateInformation(User user){
        //username不能被更新，
        //email更新时要检查是否已经存在,不校验email是否是当前用户，而是校验email是否属于别的用户
